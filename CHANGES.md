...
- Add idempotent iOS migration, SQLite snapshot backup, missing-primary restore, and optional post-backup legacy cleanup with `sqlitePlugin.prepareDatabase()`, preferring backup restore over legacy migration.
